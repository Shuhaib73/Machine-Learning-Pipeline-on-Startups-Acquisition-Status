...
app.config['MYSQL_HOST'] = "kycs-db.ct4w0uimoomh.ap-south-1.rds.amazonaws.com"
app.config['MYSQL_USER'] = "admin"
app.config['MYSQL_PASSWORD'] = "7862480Ss"
app.config['MYSQL_DB'] = "flask_web_database1"
...
def dashboard():
    if request.method == 'POST':
        ...
        try:
            ...
            model_pipe = PipelineTester('multiclass_pipeline.pkl', input_data)

            # Predict the class label for the input data
            prediction = model_pipe.predict()
